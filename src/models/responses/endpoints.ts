...
export type GraphQLGetUserTweetsAndRepliesResponse = GraphQLGetUserTweetsAndRepliesSuccessResponse
...
export type GraphQLGETEndPointResponseType<T extends GraphQLGETEndpoint> =
  ...
  T extends 'Likes' ? GraphQLGetLikesResponse :
  ...
  T extends 'UserMedia' ? GraphQLGetUserMediaResponse :
  T extends 'UserTweets' ? GraphQLGetUserTweetsResponse :
  T extends 'UserTweetsAndReplies' ? GraphQLGetUserTweetsAndRepliesResponse :
